...
public class Symbolic_loop extends AbstractNativeMethodDef {
    public Symbolic_loop() {
        super("com/lexicalscope/svm/j/instruction/symbolic/symbols/SymbolFactory", "loop", "()I");
    }
